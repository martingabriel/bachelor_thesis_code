...
namespace StudentsNotifier.MobileAppService.Models
{
    ...
    public partial class RozvrhoveAkce
    {
        public static RozvrhoveAkce FromJson(string json) => JsonConvert.DeserializeObject<RozvrhoveAkce>(json, StudentsNotifier.MobileAppService.Models.Converter.Settings);
    }
